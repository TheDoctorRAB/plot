...
xtitle=''
ytitle='Hispanic or Latino (of any race)'
#
###
#
# legend
...
#left_axis.set_xlabel(xtitle,fontsize=xaxis_fontsize)
...
plot.bar(cities,census_data[:,5],bar_width,color=bar_color0,edgecolor=edge_color0,linewidth=bar_linewidth)
