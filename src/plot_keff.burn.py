...
# plot text
#
plot_text=numpy.loadtxt('plot_labels.keff.burn.inp',dtype=str,delimiter='\n')
...
# axis
#
axis_config_major=numpy.loadtxt('axis_config.major.keff.burn.inp')
axis_config_minor=numpy.loadtxt('axis_config.minor.keff.burn.inp')
...
left_axis.plot(plot_data1[:,8],plot_data1[:,4],color=line_color1,label=curve_text[1])
left_axis.plot(plot_data2[:,8],plot_data2[:,4],color=line_color2,label=curve_text[2])
left_axis.plot(plot_data3[:,8],plot_data3[:,4],color=line_color3,label=curve_text[3])
left_axis.plot(plot_data4[:,8],plot_data4[:,4],color=line_color4,label=curve_text[4])
left_axis.plot(plot_data5[:,8],plot_data5[:,4],color=line_color5,label=curve_text[5])
left_axis.plot(plot_data6[:,8],plot_data6[:,4],color=line_color6,label=curve_text[6])
left_axis.plot(plot_data7[:,8],plot_data7[:,4],color=line_color7,label=curve_text[7])
left_axis.plot(plot_data8[:,8],plot_data8[:,4],color=line_color8,label=curve_text[8])
left_axis.plot(plot_data9[:,8],plot_data9[:,4],color=line_color9,label=curve_text[9])
left_axis.plot(plot_data10[:,8],plot_data10[:,4],color=line_color10,label=curve_text[10])
left_axis.plot(plot_data11[:,8],plot_data11[:,4],color=line_color11,label=curve_text[11])
left_axis.plot(plot_data12[:,8],plot_data12[:,4],color=line_color12,label=curve_text[12])
left_axis.plot(plot_data13[:,8],plot_data13[:,4],color=line_color13,label=curve_text[13])
left_axis.plot(plot_data14[:,8],plot_data14[:,4],color=line_color14,label=curve_text[14])
left_axis.plot(plot_data15[:,8],plot_data15[:,4],color=line_color15,label=curve_text[15])
left_axis.plot(plot_data16[:,8],plot_data16[:,4],color=line_color16,label=curve_text[16])
left_axis.plot(plot_data17[:,8],plot_data17[:,4],color=line_color17,label=curve_text[17])
left_axis.plot(plot_data18[:,8],plot_data18[:,4],color=line_color18,label=curve_text[18])
left_axis.plot(plot_data19[:,8],plot_data19[:,4],color=line_color19,label=curve_text[19])
