...
# plot text
#
title='Uranium mass as a function of time for thorium content'
xtitle='time [d]'
ytitle='$^{233}U$ mass fraction [-]'
#
###
#
# legend
...
# plot data
#
#left_axis.plot(plot_data0[:,0],plot_data0[:,8],color=line_color0,label=curve_text0,linewidth=curve_linewidth)
left_axis.plot(plot_data1[:,0],plot_data1[:,8],color=line_color1,label=curve_text1,linewidth=curve_linewidth)
left_axis.plot(plot_data2[:,0],plot_data2[:,8],color=line_color2,label=curve_text2,linewidth=curve_linewidth)
left_axis.plot(plot_data3[:,0],plot_data3[:,8],color=line_color3,label=curve_text3,linewidth=curve_linewidth)
left_axis.plot(plot_data4[:,0],plot_data4[:,8],color=line_color4,label=curve_text4,linewidth=curve_linewidth)
left_axis.plot(plot_data5[:,0],plot_data5[:,8],color=line_color5,label=curve_text5,linewidth=curve_linewidth)
left_axis.plot(plot_data6[:,0],plot_data6[:,8],color=line_color6,label=curve_text6,linewidth=curve_linewidth)
left_axis.plot(plot_data7[:,0],plot_data7[:,8],color=line_color7,label=curve_text7,linewidth=curve_linewidth)
left_axis.plot(plot_data8[:,0],plot_data8[:,8],color=line_color8,label=curve_text8,linewidth=curve_linewidth)
left_axis.plot(plot_data9[:,0],plot_data9[:,8],color=line_color9,label=curve_text9,linewidth=curve_linewidth)
left_axis.plot(plot_data10[:,0],plot_data10[:,8],color=line_color10,label=curve_text10,linewidth=curve_linewidth)
left_axis.plot(plot_data11[:,0],plot_data11[:,8],color=line_color11,label=curve_text11,linewidth=curve_linewidth)
left_axis.plot(plot_data12[:,0],plot_data12[:,8],color=line_color12,label=curve_text12,linewidth=curve_linewidth)
left_axis.plot(plot_data13[:,0],plot_data13[:,8],color=line_color13,label=curve_text13,linewidth=curve_linewidth)
left_axis.plot(plot_data14[:,0],plot_data14[:,8],color=line_color14,label=curve_text14,linewidth=curve_linewidth)
left_axis.plot(plot_data15[:,0],plot_data15[:,8],color=line_color15,label=curve_text15,linewidth=curve_linewidth)
left_axis.plot(plot_data16[:,0],plot_data16[:,8],color=line_color16,label=curve_text16,linewidth=curve_linewidth)
left_axis.plot(plot_data17[:,0],plot_data17[:,8],color=line_color17,label=curve_text17,linewidth=curve_linewidth)
left_axis.plot(plot_data18[:,0],plot_data18[:,8],color=line_color18,label=curve_text18,linewidth=curve_linewidth)
left_axis.plot(plot_data19[:,0],plot_data19[:,8],color=line_color19,label=curve_text19,linewidth=curve_linewidth)
