...
# plot diagnostics
#
left_axis.plot(plot_data0[:,0],plot_data0[:,2],color=line_color0,label=curve_text[0])
left_axis.plot(plot_data1[:,0],plot_data1[:,2],color=line_color1,label=curve_text[1])
