...
plot.bar(cities,census_data[:,3],bar_width,color=bar_color0,edgecolor=edge_color0,linewidth=bar_linewidth)
plot.get_current_fig_manager().resize(width,height)
plot.gcf().set_size_inches(50,40)
