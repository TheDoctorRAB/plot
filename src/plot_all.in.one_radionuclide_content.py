...
left_axis.plot(plot_data3[:,0],plot_data3[:,3],color=line_color3,label=curve_text3,linewidth=curve_linewidth)
left_axis.plot(plot_data4[:,0],plot_data4[:,3],color=line_color4,label=curve_text4,linewidth=curve_linewidth)
left_axis.plot(plot_data5[:,0],plot_data5[:,3],color=line_color5,label=curve_text5,linewidth=curve_linewidth)
left_axis.plot(plot_data6[:,0],plot_data6[:,3],color=line_color6,label=curve_text6,linewidth=curve_linewidth)
left_axis.plot(plot_data7[:,0],plot_data7[:,3],color=line_color7,label=curve_text7,linewidth=curve_linewidth)
left_axis.plot(plot_data8[:,0],plot_data8[:,3],color=line_color8,label=curve_text8,linewidth=curve_linewidth)
left_axis.plot(plot_data9[:,0],plot_data9[:,3],color=line_color9,label=curve_text9,linewidth=curve_linewidth)
left_axis.plot(plot_data10[:,0],plot_data10[:,3],color=line_color10,label=curve_text10,linewidth=curve_linewidth)
left_axis.plot(plot_data11[:,0],plot_data11[:,3],color=line_color11,label=curve_text11,linewidth=curve_linewidth)
left_axis.plot(plot_data12[:,0],plot_data12[:,3],color=line_color12,label=curve_text12,linewidth=curve_linewidth)
left_axis.plot(plot_data13[:,0],plot_data13[:,3],color=line_color13,label=curve_text13,linewidth=curve_linewidth)
left_axis.plot(plot_data14[:,0],plot_data14[:,3],color=line_color14,label=curve_text14,linewidth=curve_linewidth)
left_axis.plot(plot_data15[:,0],plot_data15[:,3],color=line_color15,label=curve_text15,linewidth=curve_linewidth)
left_axis.plot(plot_data16[:,0],plot_data16[:,3],color=line_color16,label=curve_text16,linewidth=curve_linewidth)
left_axis.plot(plot_data17[:,0],plot_data17[:,3],color=line_color17,label=curve_text17,linewidth=curve_linewidth)
left_axis.plot(plot_data18[:,0],plot_data18[:,3],color=line_color18,label=curve_text18,linewidth=curve_linewidth)
left_axis.plot(plot_data19[:,0],plot_data19[:,3],color=line_color19,label=curve_text19,linewidth=curve_linewidth)
