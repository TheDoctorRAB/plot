...
script,plot_datafile0,plot_datafile1=argv #add plotdatafileN for each data file to plot
###
#
# screen resolution
import Tkinter
...
#
xmin=0
xmax=numpy.amax(plot_data0[:,]) 
#
ymin=0 
ymax=numpy.amax(plot_data0[:,])
#
###
#
# axis ticks
...
left_axis.plot(plot_data1[:,0],plot_data1[:,1],color=line_color1,label=curve_text1,linewidth=curve_linewidth)
