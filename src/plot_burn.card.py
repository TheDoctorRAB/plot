...
# plot text
#
plot_text=numpy.loadtxt('plot_labels.burnup.time.inp',dtype=str,delimiter='\n')
curve_text=numpy.loadtxt('curve_labels.burnup.time.inp',dtype=str,delimiter='\n')
title=plot_text[0]
xtitle=plot_text[1]
ytitle=plot_text[2]
...
# axis
#
axis_config_major=numpy.loadtxt('axis_config.major.burnup.time.inp')
axis_config_minor=numpy.loadtxt('axis_config.minor.burnup.time.inp')
