...
# plot text
#
title='Plutonium isotope mass as a function of burnup'
...
#
curve_text0='$^{238}Pu$' #legend text
curve_text1='$^{240}Pu$' #legend text
curve_text2='$^{242}Pu$' #legend text
#
...
#
annotate_title='$0.00\ Th\ :\ 0.95\ ^{238}U\ :\ 0.05\ ^{235}U$' 
annotate_x=2
