...
# plot text
#
title='Plutonium isotope mass as a function of thorium content'
xtitle='thorium content [-]'
ytitle='radionuclide mass fraction [-]'
#
###
#
# legend
...
#
#curve_text0='$Total Pu$' #legend text
curve_text1='$^{238}Pu$' #legend text
curve_text2='$^{239}Pu$' #legend text
curve_text3='$^{240}Pu$' #legend text
curve_text4='$^{242}Pu$' #legend text
#
...
left_axis.plot(plot_data0[:,0],plot_data0[:,6],color=line_color1,label=curve_text1,linewidth=curve_linewidth)
left_axis.plot(plot_data0[:,0],plot_data0[:,7],color=line_color2,label=curve_text2,linewidth=curve_linewidth)
left_axis.plot(plot_data0[:,0],plot_data0[:,8],color=line_color3,label=curve_text3,linewidth=curve_linewidth)
left_axis.plot(plot_data0[:,0],plot_data0[:,9],color=line_color4,label=curve_text4,linewidth=curve_linewidth)
